...
public class TestYaml
{
    ...
    public void TestExtensionMethods()
    {
        ...
        act = () => tree.GetValues("Section 1:Section 1.3:LocalSetting 1.3");
        act.Should().NotThrow();

        tree.GetValues("Section 1:Section 1.3:LocalSetting 1.3").Should()
    ...
    public void TestWritingFile()
    {
        ...
        // Check created file
        tree = Configuration.From("TestFile2.yaml");
